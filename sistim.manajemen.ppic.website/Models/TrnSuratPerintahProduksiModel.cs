...
{
    public class TrnSuratPerintahProduksiModel : BaseModel
    {
        ...
        public SelectList TujuanProduksiList {set; get; }
        public SelectList BentukList { get; set; }
        public SelectList KemasanList { get; set; }
    }

    public class TrnSuratPerintahProduksiViewModel : BaseModel
    {
        public List<TrnSuratPerintahProduksiModel> ListData { set; get; }
        public TrnSuratPerintahProduksiViewModel()
        {
            ListData = new List<TrnSuratPerintahProduksiModel>();
        }
    }
}
