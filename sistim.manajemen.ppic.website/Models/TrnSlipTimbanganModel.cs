...
{
    public class TrnSlipTimbanganViewModel : BaseModel
    {
        public List<TrnSlipTimbanganModel> ListData { set; get; }
        public TrnSlipTimbanganViewModel()
        {
            ListData = new List<TrnSlipTimbanganModel>();
        }
    }
    public class TrnSlipTimbanganModel : BaseModel
    {
