...
namespace sistem.manajemen.ppic.website.App_Start
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Contents/plugins/blueimp/css/").Include(
                      "~/Contents/plugins/blueimp/css/blueimp-gallery.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/morrisStyles").Include(
                      "~/Contents/plugins/morris/morris-0.4.3.min.css"));
            ...
            // iCheck css styles
            bundles.Add(new StyleBundle("~/Contents/plugins/iCheck/iCheckStyles").Include(
                      "~/Contents/plugins/iCheck/custom.css"));
            ...
            // jqGrid styles
            bundles.Add(new StyleBundle("~/Contents/plugins/jqGrid/jqGridStyles").Include(
                      "~/Contents/plugins/jqGrid/ui.jqgrid.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/codeEditorStyles").Include(
                      "~/Contents/plugins/codemirror/codemirror.css",
                      "~/Contents/plugins/codemirror/ambiance.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/fullCalendarStyles").Include(
                      "~/Contents/plugins/fullcalendar/fullcalendar.css"));
            ...
            // ionRange styles
            bundles.Add(new StyleBundle("~/Contents/plugins/ionRangeSlider/ionRangeStyles").Include(
                      "~/Contents/plugins/ionRangeSlider/ion.rangeSlider.css",
                      "~/Contents/plugins/ionRangeSlider/ion.rangeSlider.skinFlat.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/nouiSliderStyles").Include(
                      "~/Contents/plugins/nouslider/jquery.nouislider.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/jasnyBootstrapStyles").Include(
                      "~/Contents/plugins/jasny/jasny-bootstrap.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/switcheryStyles").Include(
                      "~/Contents/plugins/switchery/switchery.css"));
            ...
            // chosen styles
            bundles.Add(new StyleBundle("~/Contents/plugins/chosen/chosenStyles").Include(
                      "~/Contents/plugins/chosen/bootstrap-chosen.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/wizardStepsStyles").Include(
                      "~/Contents/plugins/steps/jquery.steps.css"));
            ...
            // dropZone styles
            bundles.Add(new StyleBundle("~/Contents/plugins/dropzone/dropZoneStyles").Include(
                      "~/Contents/plugins/dropzone/basic.css",
                      "~/Contents/plugins/dropzone/dropzone.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/summernoteStyles").Include(
                      "~/Contents/plugins/summernote/summernote-bs4.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/toastrStyles").Include(
                      "~/Contents/plugins/toastr/toastr.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/imagecropperStyles").Include(
                      "~/Contents/plugins/cropper/cropper.min.css"));
            ...
            // jsTree styles
            bundles.Add(new StyleBundle("~/Contents/plugins/jsTree").Include(
                      "~/Contents/plugins/jsTree/style.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/chartistStyles").Include(
                      "~/Contents/plugins/chartist/chartist.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/awesomeCheckboxStyles").Include(
                      "~/Contents/plugins/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css"));

            // Clockpicker styles
            bundles.Add(new StyleBundle("~/plugins/clockpickerStyles").Include(
                      "~/Contents/plugins/clockpicker/clockpicker.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/dateRangeStyles").Include(
                      "~/Contents/plugins/daterangepicker/daterangepicker-bs3.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/sweetAlertStyles").Include(
                      "~/Contents/plugins/sweetalert/sweetalert.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/footableStyles").Include(
                      "~/Contents/plugins/footable/footable.core.css", new CssRewriteUrlTransform()));
            ...
            bundles.Add(new StyleBundle("~/plugins/select2Styles").Include(
                      "~/Contents/plugins/select2/select2.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/slickStyles").Include(
                      "~/Contents/plugins/slick/slick.css", new CssRewriteUrlTransform()));

            // Slick carousel theme Styless
            bundles.Add(new StyleBundle("~/plugins/slickThemeStyles").Include(
                      "~/Contents/plugins/slick/slick-theme.css", new CssRewriteUrlTransform()));
            ...
            bundles.Add(new StyleBundle("~/plugins/laddaStyles").Include(
                      "~/Contents/plugins/ladda/ladda-themeless.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/touchSpinStyles").Include(
                      "~/Contents/plugins/touchspin/jquery.bootstrap-touchspin.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/tourStyles").Include(
                      "~/Contents/plugins/bootstrapTour/bootstrap-tour.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/c3Styles").Include(
                      "~/Contents/plugins/c3/c3.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/markdownStyles").Include(
                      "~/Contents/plugins/bootstrap-markdown/bootstrap-markdown.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/tagInputsStyles").Include(
                      "~/Contents/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/socialButtonsStyles").Include(
                      "~/Contents/plugins/bootstrapSocial/bootstrap-social.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/textSpinnersStyles").Include(
                      "~/Contents/plugins/textSpinners/spinners.css"));
